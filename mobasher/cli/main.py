...
def _kill_processes() -> None:
    ...
    _run("pkill -f 'mobasher.cli.main asr worker' || true", cwd=root)
    _run("pkill -f 'mobasher.cli.main asr scheduler' || true", cwd=root)
    _run("pkill -f 'mobasher.asr.scheduler' || true", cwd=root)
